...
TEST_F(GJKFixture, TwoSpheresInCollision){
    ...
    ASSERT_TRUE(collides) << "spheres should not be in collision";
    ...
    ASSERT_NEAR(pointOnA.x, expectedPointOnA.x, 1E-2f);
    ASSERT_NEAR(pointOnA.y, expectedPointOnA.y, 1E-2f);
    ASSERT_NEAR(pointOnA.z, expectedPointOnA.z, 1E-2f);

    ASSERT_NEAR(pointOnB.x, expectedPointOnB.x, 1E-2f);
    ASSERT_NEAR(pointOnB.y, expectedPointOnB.y, 1E-2f);
    ASSERT_NEAR(pointOnB.z, expectedPointOnB.z, 1E-2f);
